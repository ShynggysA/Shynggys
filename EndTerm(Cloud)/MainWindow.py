...
class DatabaseManager:
    def __init__(self):
        ...
        logging.info('DatabaseManager инициализирован для MainWindow')
    ...
    def create_files_table(self):
        ...
        logging.info('Таблица файлов создана')
    ...
    logging.info('Таблица файлов карзины создана')
    ...
    def get_files_by_user(self, email):
        ...
        return files
        logging.info('Файлы пользователя получены')
    ...
    def get_basket_files_by_user(self, email):
        ...
        files = cursor.fetchall()
        return files
        logging.info('Файлы из карзины пользователя получены')
    ...
    def get_favorite_files_by_user(self, email):
        ...
        files = cursor.fetchall()
        return files
        logging.info('Файлы из избранных пользователя получены')
